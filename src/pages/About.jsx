...
const About = () => {
    ...
    const { resp: { data, loading } } = useContext(AppContext);
    const rep = data?.repository;
    // console.log('data2', rep?.languages.edges[0]);

    const results = [];

    rep?.languages.edges.forEach((item, index) => {
        results.push(
            ...
            {loading ? (
                ...
                <div className="repository-info">
                    ...
                    <div className="repository-info__header header-info">
                        ...
                        <div className="header-info__data">{rep.pushedAt}</div>
