...
const Repository = (props) => {
    ...
    return (
        <div className="repository-item">
            ...
            <div className="repository-item__title">{user.name} </div>
            ...
            <div className="repository-item__bottom">
                <div className="repository-item__star">
                    ...
                    {user.stargazerCount}</div>
                <div className="repository-item__data">{user.pushedAt}</div>
            </div>
